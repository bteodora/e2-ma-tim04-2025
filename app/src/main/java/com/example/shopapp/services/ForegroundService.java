...
public class ForegroundService extends Service {
    ...
    public static final String ACTION_STOPPED = "com.example.ACTION_STOPPED"; // Custom action for broadcast
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null)
        {
            ...
            Intent broadcastIntent = new Intent(ACTION_STOPPED);
            switch (Objects.requireNonNull(action))
            {
                ...
                case ACTION_STOP:
                    ...
                    player.stop();
                    // Send broadcast to inform the fragment
    ...
    private void startForegroundService()
    {
        ...
        Bitmap largeIconBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.ic_music);
        builder.setLargeIcon(largeIconBitmap);
        // Make head-up notification.
        builder.setFullScreenIntent(pendingIntent, true);
        builder.setOngoing(true); //pravljenje trajne notifikacije (sticky notifikacija)
